...
def main():
    #todos= [module_dir + "\\" + 'cac2o.csv', module_dir + "\\" + 'csdoo.csv', module_dir + "\\" + 'cp17o.csv', module_dir + "\\" + 'gnclo.csv',module_dir + "\\" + 'gncwo.csv','irc1o.csv',module_dir + "\\" + 'irc8o.csv', module_dir + "\\" + 'irc9o.csv',module_dir + "\\" + 'jhceo.csv',module_dir + "\\" + 'lms1o.csv',module_dir + "\\" + 'mtcfo.csv', module_dir + "\\" + 'pnc9o.csv',module_dir + "\\" + 'pndco.csv',module_dir + "\\" + 'pqcdo.csv',module_dir + "\\" + 'ptsto.csv', module_dir + "\\" + 'rcc9o.csv',module_dir + "\\" + 'rpc9o.csv',module_dir + "\\" + 'rpc2o.csv', module_dir + "\\" + 'tlc5o.csv', module_dir + "\\" + 'ttc1o.csv', module_dir + "\\" + 'ttc4o.csv', module_dir + "\\" + 'vsc2d.csv', module_dir + "\\" + 'vsc1o.csv', module_dir + "\\" + 'vsc3o.csv', module_dir + "\\" + 'yca6p.csv', module_dir + "\\" + 'ypcud.csv']
    todos = especies.csvOn
    tires = []
    dures = []
        ...
        if nameArchivo in todos:
            with open(f) as file:
                ...
                try:
                    ...
                    print("Exception: ", e, " in On at ", nombre)
